...
export const H5: FC<ComponentProps<"h5">> = ({ className, ...props }) => {
  return <h5 className={classNames(styles.h5, className)} {...props} />;
};


export const H6: FC<ComponentProps<"h6">> = ({ className, ...props }) => {
  return <h6 className={classNames(styles.h6, className)} {...props} />;
};
